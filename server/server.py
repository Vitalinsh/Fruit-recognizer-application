...
model_path = os.path.join(base_dir, 'models', "saved_models", "model1_vgg16_architecture.json")
weights_path = os.path.join(base_dir, 'models', "saved_models", "model1_vgg16_best1_weights.hdf5")
